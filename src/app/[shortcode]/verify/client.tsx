    ...
    <main className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          {schoolLogo ? (
            <img src={schoolLogo} alt={schoolName} className="mx-auto mb-3 h-16 w-16 rounded-full object-cover border-2 border-outline-variant" />
          ) : (
            <div className="mx-auto mb-3 w-16 h-16 rounded-full bg-primary-container flex items-center justify-center">
              <span className="font-headline-lg text-headline-lg text-on-primary-container font-bold">
                {schoolName.charAt(0)}
              </span>
            </div>
          )}
          <h1 className="font-headline-lg text-headline-lg text-on-surface">{schoolName}</h1>
          {schoolMotto && (
            <p className="font-body-sm text-body-sm text-on-surface-variant italic mt-1">&ldquo;{schoolMotto}&rdquo;</p>
          )}
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-5 space-y-4">
          <label className="font-label-sm text-label-sm text-on-surface-variant block">
            Enter the verification code from the report card
          </label>
